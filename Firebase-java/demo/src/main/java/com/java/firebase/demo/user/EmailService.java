...
public class EmailService {
    public void sendVerificationEmail(String recipientEmail, String verificationLink) {
        String htmlContent = "<!DOCTYPE html>"
                ...
                + "<style> body { font-family: Arial, sans-serif; background-color: #1d1413; margin: 0; padding: 0; }"
                ...
                + "<div class='content'><p>Hello Champion,</p><p>Thank you for signing up! Please confirm your email address"
                ...
                + "<div class='footer'><p>&copy; 2024 Magic The Gathering Arena. All rights reserved.</p></div></div></body></html>";
